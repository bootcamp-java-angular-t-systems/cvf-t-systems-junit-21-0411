...
public class ViewsCalculadora extends JFrame {
	...
	public double numeroAnterior = 0.0;
	JButton btnIgual;
	JLabel lblResult;
	JButton btnEliminarCaracter;
	...
	public ViewsCalculadora() {
		...
		btnEliminarCaracter = new JButton("Del");
	...
	public void simularClicEliminarCaracter() {
		ActionListener[] actionListeners = btnEliminarCaracter.getActionListeners();

		for (ActionListener listener : actionListeners) {
			ActionEvent event = new ActionEvent(btnEliminarCaracter, ActionEvent.ACTION_PERFORMED, "");
			listener.actionPerformed(event);
		}
	}

	public String getLblResultText() {
		return lblResult.getText();
	}

	public void setOperadorActual(String operador) {
	...
	public void simularClicBotonIgual() {
	    ActionListener[] actionListeners = btnIgual.getActionListeners();

	    for (ActionListener listener : actionListeners) {
	        ActionEvent event = new ActionEvent(btnIgual, ActionEvent.ACTION_PERFORMED, "");
	        listener.actionPerformed(event);
	    }
	}
